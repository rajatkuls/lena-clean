...
WAV_PATH = config_test.WAV_PATH
DATA_PATH = config_test.DATA_PATH
FEATUREPATH = config_test.FEATUREPATH

FOLDS_PATH = config_test.FOLDS_PATH


FRAME_WIDTH = config_test.FRAME_WIDTH
INV_FRAME_WIDTH = config_test.INV_FRAME_WIDTH
MIN_DUR = config_test.MIN_DUR


stWin = config_test.stWin
stStep = config_test.stStep
...
if __name__ == "__main__":
	for i in xrange(len(foldFileList)):
		...
		os.system('mkdir -p '+FEATUREPATH+str(i))
		for wavFile in foldFileList[i]:
			...
			pickle.dump(X,       open(FEATUREPATH+str(i)+'/'+getRootName(wavFile)+'_X','w'))
			pickle.dump(y_sil,   open(FEATUREPATH+str(i)+'/'+getRootName(wavFile)+'_ysil','w'))
			pickle.dump(y_class, open(FEATUREPATH+str(i)+'/'+getRootName(wavFile)+'_yclass','w'))
			pickle.dump(y_class2,open(FEATUREPATH+str(i)+'/'+getRootName(wavFile)+'_yclass2','w'))
			pickle.dump(y_class3,open(FEATUREPATH+str(i)+'/'+getRootName(wavFile)+'_yclass3','w'))
